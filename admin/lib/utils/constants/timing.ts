...
export const TIMING_INITIAL_VALUE: any[] = [
  ...
  { day: 'THU', times: [{ startTime: null, endTime: null }] },
  { day: 'FRI', times: [{ startTime: null, endTime: null }] },
  { day: 'SAT', times: [{ startTime: null, endTime: null }] },
  { day: 'SUN', times: [{ startTime: null, endTime: null }] },
];
