  ...
  const [links, setLinks] = useState([
    {
      ...
      url: 'https://foodexpress.com/foodexpress-multi-vendor/'
    },
    {
      title: t('titleDocs'),
      url: 'https://foodexpress.com/multi-vendor-doc/'
    },
    {
      title: t('titleBlog'),
      url: 'https://foodexpress.com/blog/'
    },
    {
    ...
    setLinks([
      {
        title: t('titleProductPage'),
        url:
          'https://foodexpress.com/foodexpress-multivendor-open-source-food-delivery-solution/'
      },
      {
        title: t('titleDocs'),
        url: 'https://foodexpress.com/multivendor-documentation/'
      },
      {
        title: t('titleBlog'),
        url:
          'https://foodexpress.com/blogs-foodexpress-open-source-food-delivery-solutions/'
      },
      {
        title: t('titleAboutUs'),
