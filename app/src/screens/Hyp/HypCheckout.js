...
function HypCheckout(props) {
        ...
        try {
          await createActivityMutation({
            variables: {
              ...
              module: 'HypCheckout',
              screenPath: '/Users/umarkhalid/Projects/Yalla/yalla-apps/foodexpress-multivendor-app/src/screens/Hyp/HypCheckout.js',
              type,
              details
            }
          })
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {loading ? <ActivityIndicator style={{ position: 'absolute', bottom: '50%', left: '50%' }} size='large' color='#FF6B00' /> : null}
    </View>
  )
}
