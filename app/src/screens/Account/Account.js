...
function Account(props) {
  ...
  const fetchSelectedLanguage = async () => {
    const lang = await AsyncStorage.getItem('foodexpress-language-name')
              ...
              <View style={styles(currentTheme).subContainer}>
                ...
                <View>
                  ...
                  <ButtonContainer
                    ...
                    status='null'
                    onPress={() => {
                      Linking.openURL('https://multivendor.foodexpress.com/terms')
                    }}
                  />
                  <View style={styles(currentTheme).line} />
                  ...
                  <ButtonContainer
                    ...
                    status='null'
                    onPress={() => {
                      Linking.openURL('https://multivendor.foodexpress.com/privacy')
                    }}
                  />
                </View>
