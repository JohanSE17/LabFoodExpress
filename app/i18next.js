...
const detectAndSetLanguage = async () => {
  try {
    const storedLanguage = await AsyncStorage.getItem('foodexpress-language');
    ...
    await AsyncStorage.removeItem('foodexpress-language');
    await AsyncStorage.removeItem('foodexpress-language-name');
  } catch (error) {
